...
<div class="square bg-black">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="img">
          <img class="img-fluid mt-4 mb-4" src="https://cdn.breakers-store.site/wp-content/uploads/2023/10/Arkk-800x1022.jpg" alt="" srcset="" width="90%">
        </div>
      </div>
      <div class="col-lg-6">
        <div class="paragraph mt-5">
        <h2 class="text-light ">ARK: Survival Ascended STEAM</h2>
<p class="text-danger">EGP 900.00</p>

        </div>
        <div class="content ">
        
<p class="text-light"><span class="text-success">Edition:</span> Standard</p>
        ...
        <div class="Region mt-4">
          <p class="text-success">Region <span class="text-light">:South Asia</span></p>
        </div>
        <div class="Language ">
          <p class="text-success">Language <span class="text-light"> :All</span></p>
        </div>
        <div class="quntity"> 
  ...
  <div class="w-100 text-center text-light ">ARK is reimagined from the ground-up into the next-generation of video game technology with Unreal Engine 5! Form a tribe, tame & breed hundreds of unique dinosaurs and primeval creatures, explore, craft, build, and fight your way to the top of the food-chain. Your new world awaits!
...
<div class="col-lg-3 col-md-6 col-6 " >
  <div class="card text-light"  style="background-color: #040615 ;  ">
    ...
    <div class="card-body p-2 mt-3" >
      <a href="#" class="card-title text-uppercase fs-6 font-weight-bold text-decoration-none">BATMAN:ARKHAM COLLECTION STEAM
 </a>
